...
function createSection(title, elements) {
  ...
  const fieldset = createElement('div', { class: 'ytaf-settings-section', style: { marginTop: '15px', marginBottom: '15px', padding: '10px', border: '1px solid #444', borderRadius: '5px' }}, legend, ...elements);
  return fieldset;
}
